...
import com.example.nono.s_online_clinic.repo.PharmacyRepo;
...
public class PharmacyService {
    ...
    public PharmacyModel addMedicine(PharmacyModel pharmacyModel) {
        return pharmacyRepo.save(pharmacyModel);
    }

    public List<PharmacyModel> getAllMedication() {
